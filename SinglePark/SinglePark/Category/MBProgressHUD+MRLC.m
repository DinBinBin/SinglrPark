//
//  MBProgressHUD+MRLC.m
//  MRLC
//
//  Created by DBB on 2017/9/1.
//  Copyright © 2017年 DBB. All rights reserved.
//

#import "MBProgressHUD+MRLC.h"

@implementation MBProgressHUD (MRLC)
#pragma mark 显示错误信息
...
+ (void)showMessage:(NSString *)message detailsText:(NSString *)detailsText
{
...
//    HUD.yOffset = 15.f;
    ...
    HUD.label.font = [UIFont systemFontOfSize:13]; //Johnkui - added
    [HUD hideAnimated:YES afterDelay:1.5];
}
